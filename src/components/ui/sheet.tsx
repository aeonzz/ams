...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-4 bg-secondary shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out ease-out-expo data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
