...
const multiSelectVariants = cva("m-1", {
  variants: {
    variant: {
      default:
        "borde text-foreground bg-secondary-accent hover:bg-secondary-accent/80",
      secondary:
            ...
            {selectedValues.length > 0 ? (
              <div className="flex w-full items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  />
                  <ChevronDown className="h-4 ml-2 cursor-pointer text-muted-foreground hover:text-foreground" />
                </div>
              </div>
            ) : (
