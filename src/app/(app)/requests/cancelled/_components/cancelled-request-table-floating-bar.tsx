...
interface CancelledRequestTableFloatingBarProps {
  table: Table<Request>;
}

export function CancelledRequestTableFloatingBar({
  table,
}: CancelledRequestTableFloatingBarProps) {
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              ...
              <SelectContent align="center">
                <SelectGroup>
                  {RequestStatusTypeSchema.options.map((status) => (
                    <SelectItem
                      key={status}
                      value={status}
