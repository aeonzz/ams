...
interface JobRequestTableToolbarActionsProps {
  table: Table<DepartmentJobRequest>;
  fileName: string;
  children?: React.ReactNode;
}

export function JobRequestTableToolbarActions({
  table,
  fileName,
  children,
}: JobRequestTableToolbarActionsProps) {
  return (
