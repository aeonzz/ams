...
interface OpenRequestsTableProps {
  data: Request[];
}

export default function OpenRequestsTable({ data }: OpenRequestsTableProps) {
  ...
  return (
    <div className="rounded-md border p-3">
      <div className="flex items-center justify-between px-3 py-1">
        <H3 className="font-semibold tracking-tight">Open Requests</H3>
      </div>
