...
import { completeVenueRequest } from "@/lib/actions/venue";

interface CompleteVenuRequestProps {
  requestId: string;
}

export default function CompleteVenuRequest({
  requestId,
}: CompleteVenuRequestProps) {
