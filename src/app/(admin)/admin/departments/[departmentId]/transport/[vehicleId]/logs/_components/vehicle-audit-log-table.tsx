...
import { VehicleAuditLogTableType } from "./type";
import JsonViewer from "../../../../facilities/[venueId]/logs/_components/json-viewer";

interface VehicleAuditLogTableProps {
  data: VehicleAuditLogTableType[];
  globalFilter: string;
  setGlobalFilter: (globalFilter: string) => void;
}

export default function VehicleAuditLogTable({
  data,
  globalFilter,
  setGlobalFilter,
}: VehicleAuditLogTableProps) {
  const columns: ColumnDef<VehicleAuditLogTableType>[] = React.useMemo(
    () => [
      {
        accessorKey: "id",
        header: ({ column }) => (
