...
import {
  ...
  type CreateSupplyCategory,
} from "@/lib/schema/resource/supply-category";
import { createCategory } from "@/lib/actions/supply-category";

interface SupplyCategoriesDialogProps {}

export default function SupplyCategoriesDialog({}: SupplyCategoriesDialogProps) {
  const dialogManager = useDialogManager();
  const [alertOpen, setAlertOpen] = React.useState(false);

  const form = useForm<CreateSupplyCategory>({
    resolver: zodResolver(createSupplyCategory),
    defaultValues: {
      name: "",
    },
  });
  ...
  const { mutateAsync, isPending } = useServerActionMutation(createCategory);
  ...
  return (
    <Dialog
      open={dialogManager.activeDialog === "supplyCategoriesDialog"}
    ...
    >
      ...
      >
        ...
        <DialogHeader>
          <DialogTitle>All Supply Categories</DialogTitle>
        </DialogHeader>
        <div className="p-3">
          <CategoriesTable
